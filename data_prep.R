...
# use lubridate
ssn_beg_date <- ymd_hms(paste(season[,1], season[,2], season[,3], "T00", "00", "00",sep="-"), tz = "EST5EDT")
ssn_end_date <- ymd_hms(paste(season[,1], season[,4], season[,5], "T23", "59", "59", sep="-"), tz = "EST5EDT")
